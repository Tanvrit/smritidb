...
**conduct@kanervalabs.com** (or, until that mailbox exists, by opening a
confidential issue and tagging a maintainer).
...
**1. Correction** — Private, written warning, with clarity around the nature of
